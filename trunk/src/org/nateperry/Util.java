...
import org.nateperry.graphicpages.Globals;
...
public class Util {
	...
	public static File getPreferredFileDirectory(ContextWrapper context) {
		...
		switch (org.nateperry.graphicpages.Globals.PREFERRED_FILE_LOCATION) {
			case INTERNAL:
			...
			case EXTERNAL:
		    	...
		    	if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
			    	...
			    	File xRootDir = Environment.getExternalStorageDirectory();
			    	dir = new File(xRootDir, Globals.EXTERNAL_DATA_FOLDER);
